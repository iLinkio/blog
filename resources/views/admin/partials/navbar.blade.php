<aside class="left-sidebar">
    <!-- Sidebar scroll-->
    <div class="scroll-sidebar ps ps--theme_default" data-ps-id="096e2362-3bf5-bc30-fa17-6c9ee65e13a0">
        <!-- Sidebar navigation-->
        <nav class="sidebar-nav active">
            <ul id="sidebarnav" class="in">
                <li class="active"> <a class="waves-effect waves-dark active" href="index.html" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a></li>
            ...
            <div class="text-center mt-4">
                <a href="https://wrappixel.com/templates/adminpro" class="btn waves-effect waves-light btn-info hidden-md-down text-white"> Upgrade to Pro</a>
            </div>
        </nav>
